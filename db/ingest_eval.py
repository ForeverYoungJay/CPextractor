    ...
    try:
        ...
        conn.execute(
            ...
            INSERT INTO evaluation_runs (
                doi, model_evaluate, verdict, overall_score,
                document_confidence, document_confidence_score, quality_tier,
                rule_score, llm_score, review_recommended,
            ...
            VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s::jsonb,%s::jsonb);
            """,
            (
                doi,
                model_evaluate,
                ...
                confidence.get("rule_score"),
                confidence.get("llm_score"),
        ...
        for audit in evaluation.get("parameter_audits", []) or []:
            ...
            conn.execute(
                ...
                INSERT INTO parameter_audits (
                    doi, location, canonical_name, symbol, verdict, score,
